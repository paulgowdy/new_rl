...
class ddpg_agent(object):
	...
	def create_critic_network(self,inputdims,actiondims):
		...
		den3 = c.add(Dense(200,1,stddev=1))
	...
	def play_one_ep(self, env, noise_level, frameskip, max_steps = 50000):
		...
		if len(self.reward_collector) % 10 == 0:
			...
			plt.plot(self.reward_collector)
			plt.pause(0.001)
...
if __name__=='__main__':
	...
	def train(eps, save_interval = 200, frameskip = 3):
		...
		for i in range(eps):
			...
			agent.play_one_ep(env, nl, frameskip)
